...
- To analyze health insurance customer data.
- To identify the key factors affecting insurance charges.
- To compare insurance costs across different age groups.
- To study the impact of smoking habits on medical expenses.
- To understand the relationship between BMI and insurance charges.
...
Smoker: Indicates whether the customer is a smoker or non-smoker.

Region: Residential region of the customer.

Charges: Medical insurance cost charged to the customer.
...
The health insurance dataset is collected from a publicly available source such as Kaggle. The dataset is loaded into Python using the Pandas library.

2. Data Cleaning

Data cleaning is performed to ensure data quality. Missing values, duplicate records, and inconsistent data entries are checked and handled appropriately.

3. Exploratory Data Analysis (EDA)

Exploratory Data Analysis helps understand the dataset through statistical summaries and visualizations. Various charts and graphs are used to identify trends, patterns, and outliers.

4. Data Visualization

Visualization plays a key role in presenting analytical findings. Bar charts, pie charts, histograms, scatter plots, and box plots are used to represent the data effectively.
...
- Smokers generally incur significantly higher insurance charges than non-smokers.
- Insurance costs tend to increase with age.
- Customers with higher BMI values often experience higher medical expenses.
- Regional differences may influence insurance charges.
- Family size can have a moderate impact on healthcare costs.
- Smoking status is one of the strongest predictors of insurance expenses.
...
These enhancements can further increase the value and practical application of the project.
